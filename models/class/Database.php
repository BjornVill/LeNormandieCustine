...
class Database{
    ...
    public function __construct(string $db_name, int $db_port = 3306, string $db_user = 'olivierlejemble', string $db_pass = 'df7303d2ea24e13f76b86682968d14df',string $db_host = 'db.3wa.io')
    {
